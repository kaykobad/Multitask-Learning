...
"""Model defination for the ViTx3D Video Model."""

import tensorflow as tf

from modeling.common import transformers
...
class ViTx3D(tf.keras.layers.Layer):
    ...
    def __init__(self,
                 ...
                 max_vertical_buckets=4,
                 max_horizontal_buckets=4,
                 ...
                 name="vi_tx_3d",
                 **kwargs):
        super(ViTx3D, self).__init__(name=name)
