...
from data.datasets import toy_dataset, audioset_dataset
...
DS_TO_FACTORY = {
    ...
    'AUDIOSET': audioset_dataset.AudiosetFactory,
}


def get_ds_factory(dataset_name='audioset', override_args=None):
