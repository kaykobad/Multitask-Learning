...
def resnet18(output_stride, BatchNorm, pretrained=True, input_dim=3):
    """Constructs a ResNet-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], output_stride, BatchNorm, pretrained=pretrained, input_dim=input_dim, weight='resnet18')
    return model


def resnet34(output_stride, BatchNorm, pretrained=True, input_dim=3):
    """Constructs a ResNet-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], output_stride, BatchNorm, pretrained=pretrained, input_dim=input_dim, weight='resnet34')
    return model
...
def resnet101(output_stride, BatchNorm, pretrained=True, input_dim=3):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], output_stride, BatchNorm, pretrained=pretrained, input_dim=input_dim, weight='resnet101')
    return model
...
def build_backbone(backbone, output_stride, BatchNorm, input_dim=3, pretrained=True):
    if backbone == 'resnet101':
        ...
        return resnet34(output_stride, BatchNorm, input_dim=input_dim, pretrained=pretrained)
    elif backbone == 'resnet18':
        return resnet18(output_stride, BatchNorm, input_dim=input_dim, pretrained=pretrained)
    else:
        raise NotImplementedError
...
class Decoder(nn.Module):
    def __init__(self, num_classes, backbone, BatchNorm, num_modalities=1):
        ...
        if backbone == 'resnet18' or backbone == 'resnet34' or backbone == 'resnet50' or backbone == 'resnet101':
            low_level_inplanes = 256
            last_conv_input = 48 + 256
        else:
            raise NotImplementedError
