...
class TrainerMultimodal(object):
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            p1 = pred[0].reshape(512, 512, 1)
            p2 = pred[1].reshape(512, 512, 1)
            # -------------------- My Modification End ----------------------
        ...
        mIoUs.append(round(mIoU*100, 2))

        cv2.imwrite(f'predictions/1_{epoch}.png', p1)
        cv2.imwrite(f'predictions/2_{epoch}.png', p2)
